...
if ($object->xpdo) {
	...
	switch ($options[xPDOTransport::PACKAGE_ACTION]) {
		...
		case xPDOTransport::ACTION_UPGRADE:
			...
			$properties = array(
//				'name' => 'modxpo2017ws Images'
//				,'description' => 'Default media source for images of modxpo2017ws items'
...
//						'name' => 'maxUploadWidth','desc' => 'ms2_source_maxUploadWidth_desc','type' => 'numberfield','lexicon' => 'minishop2:setting',
//						'value' => 1920,
//					),
//					'maxUploadHeight' => array(
//						'name' => 'maxUploadHeight','desc' => 'ms2_source_maxUploadHeight_desc','type' => 'numberfield','lexicon' => 'minishop2:setting',
//						'value' => 1080,
//					),
//					'maxUploadSize' => array(
//						'name' => 'maxUploadSize','desc' => 'ms2_source_maxUploadSize_desc','type' => 'numberfield','lexicon' => 'minishop2:setting',
//						'value' => 10485760,
//					),
//					'imageNameType' => array(
//						'name' => 'imageNameType','desc' => 'ms2_source_imageNameType_desc','type' => 'list','lexicon' => 'minishop2:setting',
//						'options' => array(
