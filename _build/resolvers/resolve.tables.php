...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modelPath = $modx->getOption('modxpo2017ws_core_path', null,
                    $modx->getOption('core_path') . 'components/modxpo2017ws/') . 'model/';
            $modx->addPackage('modxpo2017ws', $modelPath);

            $manager = $modx->getManager();
            $objects = array();
            $schemaFile = MODX_CORE_PATH . 'components/modxpo2017ws/model/schema/modxpo2017ws.mysql.schema.xml';
