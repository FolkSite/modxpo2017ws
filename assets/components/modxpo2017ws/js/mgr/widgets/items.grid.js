        ...
        viewConfig: {
            ...
            getRowClass: function (rec) {
                return !rec.data.active
                    ? 'modxpo2017ws-grid-row-disabled'
                    : '';
            }
        },
        paging: true,
...
Ext.extend(modxpo2017ws.grid.Items, MODx.grid.Grid, {
    windows: {},
    ...
    getMenu: function (grid, rowIndex) {
        ...
        var menu = modxpo2017ws.utils.getMenu(row.data['actions'], this, ids);
    ...
    getColumns: function () {
        return [{
            ...
            dataIndex: 'active',
            renderer: modxpo2017ws.utils.renderBoolean,
            sortable: true,
            width: 100,
        }, {
            header: _('modxpo2017ws_grid_actions'),
            dataIndex: 'actions',
            renderer: modxpo2017ws.utils.renderActions,
            sortable: false,
            width: 100,
            id: 'actions'
        }];
    ...
    getTopBar: function () {
        return [{
            text: '<i class="icon icon-plus"></i>&nbsp;' + _('modxpo2017ws_item_create'),
            handler: this.createItem,
            scope: this
        }, '->', {
            xtype: 'modxpo2017ws-field-search',
            width: 250,
            listeners: {
                search: {
                    fn: function (field) {
